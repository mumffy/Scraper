namespace University.Migrations
{
    ...
    public partial class ComplexDataModel : DbMigration
    {
        public override void Up()
        {
            ...
            // create a default Department for existing Course entities to associate with
            // default Identity seed and increment are: 1 and 1
            Sql("INSERT INTO dbo.Department (Name, Budget, StartDate) VALUES ('Temp', 0.00, GETDATE())");

            // existing Course entities will get the default DepartmentID of 1
